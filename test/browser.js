...
/*!
   * Aliases.
   */
function e(t,n){return r[n]=r[t],e}("isOk","ok")("isNotOk","notOk")("throws","throw")("throws","Throw")("isExtensible","extensible")("isNotExtensible","notExtensible")("isSealed","sealed")("isNotSealed","notSealed")("isFrozen","frozen")("isNotFrozen","notFrozen")("isEmpty","empty")("isNotEmpty","notEmpty")}},function(e,t,n){const o=n(42);describe("Connection",function(){describe("new Connection()",function(){it("new Connection(from, to) => {Connection}",function(){const e=new o("from","to");expect(e).to.be.an.instanceOf(o),expect(e.id).to.be.a("string"),expect(e.a).to.eql("from"),expect(e.b).to.eql("to"),expect(e.weight).to.be.finite}),it("new Connection(from, to, weight) => {Connection}",function(){const e=2*Math.random()-1,t=new o("from","to",e);expect(t).to.be.an.instanceOf(o),expect(t.id).to.be.a("string"),expect(t.a).to.eql("from"),expect(t.b).to.eql("to"),expect(t.weight).to.eql(e)})})})},function(e,t,n){const o=n(43);e.exports=function(e,t,n,r){this.id=o(),this.a=e,this.b=t,this.weight=null==n?2*Math.random()-1:n}},function(e,t,n){var o=n(44),r=n(15),i=n(45),s=0,a=4,c=36,u=Math.pow(c,a);function f(){return r((i()*u<<0).toString(c),a)}function p(){return s=s<u?s:0,++s-1}function l(){return"c"+(new Date).getTime().toString(c)+r(p().toString(c),a)+o()+(f()+f())}l.slug=function(){var e=(new Date).getTime().toString(36),t=p().toString(36).slice(-4),n=o().slice(0,1)+o().slice(-1),r=f().slice(-2);return e.slice(-2)+t+n+r},l.isCuid=function(e){return"string"==typeof e&&!!e.startsWith("c")},l.isSlug=function(e){if("string"!=typeof e)return!1;var t=e.length;return t>=7&&t<=10},l.fingerprint=o,e.exports=l},function(e,t,n){var o=n(15),r="object"==typeof window?window:self,i=Object.keys(r).length,s=o(((navigator.mimeTypes?navigator.mimeTypes.length:0)+navigator.userAgent.length).toString(36)+i.toString(36),4);e.exports=function(){return s}},function(e,t){var n,o=window.crypto||window.msCrypto;if(o){var r=Math.pow(2,32)-1;n=function(){return Math.abs(o.getRandomValues(new Uint32Array(1))[0]/r)}}else n=Math.random;e.exports=n}]);