...
/*!
   * Aliases.
   */
function e(t,n){return r[n]=r[t],e}("isOk","ok")("isNotOk","notOk")("throws","throw")("throws","Throw")("isExtensible","extensible")("isNotExtensible","notExtensible")("isSealed","sealed")("isNotSealed","notSealed")("isFrozen","frozen")("isNotFrozen","notFrozen")("isEmpty","empty")("isNotEmpty","notEmpty")}},function(e,t,n){const o=n(43);describe("Connection",function(){describe("new Connection()",function(){it("new Connection(from, to) => {Connection}",function(){const e=new o("from","to");expect(e).to.be.an.instanceOf(o),expect(e.id).to.be.a("string"),expect(e.a).to.eql("from"),expect(e.b).to.eql("to"),expect(e.weight).to.be.finite}),it("new Connection(from, to, weight) => {Connection}",function(){const e=2*Math.random()-1,t=new o("from","to",e);expect(t).to.be.an.instanceOf(o),expect(t.id).to.be.a("string"),expect(t.a).to.eql("from"),expect(t.b).to.eql("to"),expect(t.weight).to.eql(e)})})})},function(e,t,n){const o=n(15);e.exports=function(e,t,n,r){this.id=o(),this.a=e,this.b=t,this.weight=null==n?2*Math.random()-1:n,this.queue={forward:[],backward:[]}}},function(e,t,n){var o=n(16),r="object"==typeof window?window:self,i=Object.keys(r).length,s=o(((navigator.mimeTypes?navigator.mimeTypes.length:0)+navigator.userAgent.length).toString(36)+i.toString(36),4);e.exports=function(){return s}},function(e,t){var n,o=window.crypto||window.msCrypto;if(o){var r=Math.pow(2,32)-1;n=function(){return Math.abs(o.getRandomValues(new Uint32Array(1))[0]/r)}}else n=Math.random;e.exports=n},function(e,t,n){const o=n(47);describe("Neuron",function(){describe("new Neuron()",function(){it("new Neuron() => {Neuron}",function(){const e=new o;expect(e).to.be.an.instanceOf(o),expect(e.id).to.be.a("string"),expect(e.bias).to.be.finite,expect(e.incoming.connections).to.exist,expect(e.incoming.weights).to.exist,expect(e.incoming.neurons).to.exist,expect(e.outgoing.connections).to.exist,expect(e.outgoing.weights).to.exist,expect(e.outgoing.neurons).to.exist})})})},function(e,t,n){const o=n(15);e.exports=function(e,t){this.id=o(),this.bias=null==e?2*Math.random()-1:e,this.incoming={connections:{},weights:{},neurons:{}},this.outgoing={connections:{},weights:{},neurons:{}},this.fire=function(e,t){},this.update=function(e,t,n){}}}]);